...
notif_type_tuple_dict = {
    ...
    NOTIF_ENTITY_ATTACH: WIZCARD_ENTITY_ATTACH,
    NOTIF_ENTITY_DETACH: WIZCARD_ENTITY_DETACH,
...
feed_schemas = {
    "CMP": ["name", "description", "address", "phone", "website", "tags", "venue", "email"],
