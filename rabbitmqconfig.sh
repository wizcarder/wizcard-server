...
#/usr/local/sbin/rabbitmqctl set_user_tags wizcard_user administrator
#/usr/local/sbin/rabbitmqctl set_user_tags reco_user administrator
#/usr/local/sbin/rabbitmqctl set_user_tags location_user administrator

#/usr/local/sbin//usr/local/sbin/rabbitmqctl delete_user guest
