...
provision('com.beta.wizcard', open('./certs/wizcard_ios_apns_production.pem').read(), 'production')
...
notify('com.beta.wizcard', '6c4f3dcb31cb45bdaf399206ea065b9795bee698cd56a60bcd40ee336741d4dd', {'aps':{'alert':'senthil, test apns notif!'}})
